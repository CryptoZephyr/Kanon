...
- `packages/permissions` normalizes the Privy-backed company terms, derives deterministic `permissionHash`, and classifies authority changes with proof-backed coverage; the Privy compiler is the next phase.
